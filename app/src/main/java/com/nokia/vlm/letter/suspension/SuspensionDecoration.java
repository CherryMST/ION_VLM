package com.nokia.vlm.letter.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#FFe8e8e8");
    private static int COLOR_TITLE_FONT = Color.parseColor("#FF999999");
    private static int mTitleFontSize;//title字体大小

    private int mHeaderViewCount = 0;

    private int leftOffse;//左边距 偏移量
    ...
    public SuspensionDecoration setLeftOffse(int leftOffse) {
        this.leftOffse = leftOffse;
        return this;
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position > -1) {
                ZLog.d("position:"+position+"   title:"+mDatas.get(position).getSuspensionTag());
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft() + leftOffse, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
