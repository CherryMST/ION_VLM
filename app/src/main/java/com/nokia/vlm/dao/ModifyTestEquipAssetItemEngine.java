...
import com.nokia.vlm.callback.ModifyTestEquipAssetItemCallback;
...
public class ModifyTestEquipAssetItemEngine extends BaseDao<ModifyTestEquipAssetItemCallback>{

        private String url = "update";

        public void modifyInTestEquipAsset() {
        ...
        protected void onRequestFailed(Call call, Exception e) {
            notifyDataChangedInMainThread(new CallbackHelper.Caller<ModifyTestEquipAssetItemCallback>() {
                @Override
                public void call(ModifyTestEquipAssetItemCallback ac) {
//                    ac.modifyTestEquipAssetItem(-1001, "请求失败，请检查网络", null);
                }
            });
        }
...
//                        ac.modifyTestEquipAssetItem(1,responseJson.msg, responseJson);
//                    }
//                }
//            });
        }
