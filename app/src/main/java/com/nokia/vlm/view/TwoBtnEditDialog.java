 ...
 * 两按钮的dialog
 */
public class TwoBtnEditDialog extends Dialog implements View.OnClickListener {
    ...
    public TwoBtnEditDialog(Context context) {
        this(context, R.style.theme_dialog_alert);
    }

    public TwoBtnEditDialog(Context context, int themeResId) {
        super(context, themeResId);

        super.setContentView(R.layout.layout_two_dialog_edit);
