 ...
 * 渠道包管理
 *
 * MultiChannelBuildTool.py(PC端的一个工具)打包APK ，渠道可在配置文件中写好，
 * 谁都可以打包哦！
 *
 ...
 *
 * 在/META_INF/zchannel_渠道号
 * 注意：
 * 读取SharedPreferences 统一使用 ZooerSettings  正式用的时候要注意了
 *
 * @author luohongbo
 *
 */
...
public class ChannelUtil {
    ...
    private static final String CHANNEL_KEY = "zchannel";
     ...
     * @return
     */
    public static String genChannel(){
        return getChannel(ZooerApp.getAppSelf(), "");
    }
    /**
